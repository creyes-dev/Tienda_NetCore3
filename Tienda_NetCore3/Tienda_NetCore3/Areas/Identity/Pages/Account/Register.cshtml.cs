...
namespace Tienda_NetCore3.Areas.Identity.Pages.Account
{
    [Authorize]
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var user = new Tienda_NetCore3.Models.Usuario 
                { 
                ...
                if (result.Succeeded)
                {
                    ...
                    {
                        // Si los roles no están registrados entonces proceder a crearlos
                        await _roleManager.CreateAsync(new IdentityRole(SD.Admin));
                        await _roleManager.CreateAsync(new IdentityRole(SD.Manager));
                    }

                    string rol = Request.Form["rdUserRole"].ToString();
